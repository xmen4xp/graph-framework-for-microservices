...
import (
	"context"
	"/build/nexus-gql/graph/generated"
	"/build/nexus-gql/graph/model"
)
...
// TestOptionalParentPathParamChild is the resolver for the TestOptionalParentPathParamChild field.
func (r *gns_GnsResolver) TestOptionalParentPathParamChild(ctx context.Context, obj *model.GnsGns, id *string) ([]*model.OptionalparentpathparamOptionalParentPathParam, error) {
	return getGnsGnsTestOptionalParentPathParamChildResolver(obj, id)
}
