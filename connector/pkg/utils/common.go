...
const (
	...
	ReplicationConfigCRD = "replicationconfigs.connect.admin.nexus.com"
	NexusEndpointCRD     = "nexusendpoints.connect.admin.nexus.com"
...
func NexusDatamodelCRDs(group string) bool {
	return strings.Contains(group, "admin.nexus.com")
}
