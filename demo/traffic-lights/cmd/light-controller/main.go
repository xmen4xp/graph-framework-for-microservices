...
import (
	...
	"trafficlightdemo/pkg/controller"
...
func main() {
	...
	log.Infof("Traffic Light Controller creating client to host at : %s", host)
	...
	controller.ControllerInit(nexusClient, uint64(instanceId), log, gctx, cancelFn)
	// look for signal
	g.Go(func() error {
